...
Task.create(title: '昼食の用意', category_name: :housework, points: 30)
Task.create(title: '夕食の用意', category_name: :housework, points: 70)
Task.create(title: '食事の後片付け', category_name: :housework, points: 30)
Task.create(title: 'ゴミ出し', category_name: :housework, points: 20)
Task.create(title: '掃除機がけ', description: 'コロコロなども含む', category_name: :housework, points: 50)
Task.create(title: '洗濯', category_name: :housework, points: 40)

# 仕事にはとりあえずこんなのが考えられるかな。
Task.create(title: '出社・勤務開始', category_name: :work, points: 50)
Task.create(title: '業務', category_name: :work, points: 50)
Task.create(title: '残業', category_name: :work, points: 40)
Task.create(title: '会議出席', category_name: :work, points: 30)
Task.create(title: '会議発表', category_name: :work, points: 100)
Task.create(title: '出張', category_name: :work, points: 100)

# 仕事や資格に繋がる勉強の項目だよ。多すぎて書けないよ。好きに作ってもらうよ。
Task.create(title: '英語(TOEIC等)', category_name: :study_work, points: 30)
Task.create(title: '資格の勉強', category_name: :study_work, points: 40)
Task.create(title: '仕事の勉強', category_name: :study_work, points: 40)

# 学校に関するタスクの初期データだよ。
Task.create(title: '登校', category_name: :school, points: 30)
Task.create(title: '授業1コマ', category_name: :school, points: 20)
Task.create(title: 'テスト1教科', category_name: :school, points: 50)
Task.create(title: '部活：練習1時間', category_name: :school, points: 20)
...
Task.create(title: '地学', category_name: :study, points: 20)
...
Task.create(title: 'テスト勉強', description: '教科に関わらず定期試験に関わる勉強はこちら。頑張れ！', category_name: :study, points: 50)
Task.create(title: '受験勉強', description: '教科に関わらず入学試験に関わる勉強はこちら。めっちゃ頑張れ！', category_name: :study, points: 60)

# ペットのお世話は色々あるけど、代表的なものを書いていくね。
Task.create(title: 'ご飯・水の用意', category_name: :pet, points: 10)
Task.create(title: '散歩', category_name: :pet, points: 40)
...
Task.create(title: '買い出し', description: '目安として3〜4日分の食料品、生活必需品等の買い出し', points: 70)
